...
<section class="max-w-[1280px] mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
    ...
    <div class="flex justify-center items-center">
        <img src="/images/p_img1.png" alt="Classic T-Shirt" class="rounded-xl border border-border shadow-lg w-full max-w-[480px] object-cover" style="max-height:520px;">
    </div>
    <!-- Product Details -->
    <div class="flex flex-col gap-8">
        ...
        <button
            ...
            data-product-image="/images/p_img1.png"
