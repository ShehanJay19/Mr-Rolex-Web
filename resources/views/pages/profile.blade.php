...
<section class="max-w-[700px] mx-auto px-6 py-16">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col md:flex-row gap-8 mb-12">
        ...
        <div class="flex-1 flex flex-col gap-4">
            ...
            <button class="mt-4 px-6 py-2 border rounded-full font-semibold hover:bg-black hover:text-white transition w-fit">Edit Profile</button>
        </div>
    </div>
